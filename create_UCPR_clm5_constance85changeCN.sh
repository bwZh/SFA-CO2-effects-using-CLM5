...
export SIMYR=2010
export CESM_CASE_NAME=${CLM_USRDAT_NAME}-${CESM_COMPSET}-UCPR-RCP85-changeCN-`date "+%Y-%m-%d"`
...
ls -l /pic/projects/landuq/liuy716/liuy716_constance_sbr_task1/clmforc_hanford_PRIMA_rcp85_0.0625_20191125/*.nc | awk '{ print $9}' | awk -F'.' '{print $4}' | \
awk -v INPUTDATA_DIR=${INPUTDATA_DIR} -v CLM_USRDAT_NAME=${CLM_USRDAT_NAME} \
'{ system( "ln -s /pic/projects/landuq/liuy716/liuy716_constance_sbr_task1/clmforc_hanford_PRIMA_rcp85_0.0625_20191125/clmforc.hanford." $1 ".nc " INPUTDATA_DIR"/cesm_inputdata/atm/datm7/" CLM_USRDAT_NAME "/CLM1PT_data/" $1 ".nc") }'
...
./xmlchange --file env_run.xml --id REST_N --val 86
...
export stream_fldfilename_ndep=${CESM_INPUTDATA_DIR}/lnd/clm2/ndepdata/fndep_clm_SSP585_b.e21.BWSSP585cmip6.f09_g17.CMIP6-SSP5-8.5-WACCM.001_2014-2101_monthly_0.9x1.25_c190211.nc
...
stream_fldfilename_ndep='$stream_fldfilename_ndep'
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 2015 2015 2100",
     ...
     "datm.streams.txt.co2tseries.rcp8.5 2015 2015 2100"
EOF
...
# Modify datm streams
cp -f ${CESM_CASE_DIR}/${CESM_CASE_NAME}/CaseDocs/datm.streams.txt.co2tseries.rcp8.5 ${CESM_CASE_DIR}/${CESM_CASE_NAME}/user_datm.streams.txt.co2tseries.rcp8.5
chmod +rw ${CESM_CASE_DIR}/${CESM_CASE_NAME}/user_datm.streams.txt.co2tseries.rcp8.5
