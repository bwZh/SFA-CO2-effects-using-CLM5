...
export SIMYR=2010
export CESM_CASE_NAME=${CLM_USRDAT_NAME}-${CESM_COMPSET}-UCPR-historical-`date "+%Y-%m-%d"`
...
./xmlchange --file env_run.xml --id RUN_STARTDATE --val 1985-01-01
./xmlchange --file env_run.xml --id STOP_OPTION --val nyears
./xmlchange --file env_run.xml --id DATM_CLMNCEP_YR_START --val 1985
./xmlchange --file env_run.xml --id DATM_CLMNCEP_YR_ALIGN --val 1985
...
export flanduse_timeseries=${CESM_INPUTDATA_DIR}/lnd/clm2/surfdata_map/landuse.timeseries_UCPRhistorical.nc
export finidat=${CESM_INPUTDATA_DIR}/lnd/clm2/initdata_map/1kmx1km_UCPR-I2000Clm50SpGs-UCPR-spinup-2019-07-04.clm2.r.2310-01-01-00000.nc
...
model_year_align_ndep = 1985
stream_year_first_ndep = 1985
...
streams = "datm.streams.txt.CLM1PT.CLM_USRDAT 1985 1985 2014",
     "datm.streams.txt.presaero.clim_2000 1 1 1",
     "datm.streams.txt.topo.observed 1 1 1",
     "datm.streams.txt.co2tseries.20tr 1985 1985 2014"
EOF
...
# Modify datm streams
cp -f ${CESM_CASE_DIR}/${CESM_CASE_NAME}/CaseDocs/datm.streams.txt.co2tseries.20tr ${CESM_CASE_DIR}/${CESM_CASE_NAME}/user_datm.streams.txt.co2tseries.20tr
chmod +rw ${CESM_CASE_DIR}/${CESM_CASE_NAME}/user_datm.streams.txt.co2tseries.20tr
