...
export SIMYR=2010
export CESM_CASE_NAME=${CLM_USRDAT_NAME}-${CESM_COMPSET}-UCPR-RCP45-changeCN-`date "+%Y-%m-%d"`
...
export stream_fldfilename_ndep=${CESM_INPUTDATA_DIR}/lnd/clm2/ndepdata/fndep_clm_SSP245_b.e21.BWSSP245cmip6.f09_g17.CMIP6-SSP2-4.5-WACCM.001_2014-2101_monthly_0.9x1.25_c190401.nc
